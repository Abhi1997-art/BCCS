...
public class AgentTdsDetail {
	...
	private String relatedAccountMemberName;
	private String relatedAccountFatherName;
	...
	public AgentTdsDetail(Integer id, Integer agentId, Integer memberId, Integer codeNo, String memberName, Integer memberNo, String currentAddress, 
			String landmark, Boolean isDefaulter, Integer accountId, String accountNumber, Integer relatedAccountMemberId, String relatedAccountMemberName, 
			String relatedAccountFatherName, Date createdAt, BigDecimal totalCommission, BigDecimal tds, BigDecimal netCommission, Integer branchId, String branchName) {
		super();
		this.id = id;
		...
		this.relatedAccountMemberName = relatedAccountMemberName;
		this.relatedAccountFatherName = relatedAccountFatherName;
	...
	public String getRelatedAccountMemberName() {
		return relatedAccountMemberName;
	}


	public void setRelatedAccountMemberName(String relatedAccountMemberName) {
		this.relatedAccountMemberName = relatedAccountMemberName;
	}


	public String getRelatedAccountFatherName() {
		return relatedAccountFatherName;
	}


	public void setRelatedAccountFatherName(String relatedAccountFatherName) {
		this.relatedAccountFatherName = relatedAccountFatherName;
	}
